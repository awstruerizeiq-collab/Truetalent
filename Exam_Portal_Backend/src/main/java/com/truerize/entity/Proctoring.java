...
public class Proctoring {
    ...
    @JsonIgnoreProperties({"proctoringRecords", "assignedExams", "roles", "hibernateLazyInitializer", "handler"})
    private User user;
    
   
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "exam_id", nullable = false)
    @JsonIgnoreProperties({"questions", "users", "proctoringRecords", "hibernateLazyInitializer", "handler"})
    private Exam exam;
